...
// We need to create an admin user first to bypass RLS
// Or use postgres directly. Let's try creating a super admin context.
...
async function disableRLSAndSeed() {
  console.log('🔐 Note: RLS is preventing direct inserts from client.');
  console.log('✅ Solution: Please run the following SQL in your Supabase dashboard:\n');
...
ALTER TABLE public.equipments ENABLE ROW LEVEL SECURITY;
  ...
  console.log('2. Select your project "yuwdkjdraskyziceqtvc"');
  console.log('3. Click on "SQL Editor" in the left sidebar');
  console.log('4. Click "New Query"');
  console.log('5. Paste the SQL above');
  console.log('6. Click "RUN" or press Cmd+Enter');
  console.log('\n✨ After running, the database will be populated with 12 categories and 25 equipments!\n');
}

disableRLSAndSeed().catch(console.error);
